...
public class CloudSearchMap extends Activity implements CloudListener {
	private static final String LTAG = CloudSearchMap.class.getSimpleName();
	...
	protected void onCreate(Bundle icicle) {
		...
		CloudManager.getInstance().init(CloudSearchMap.this);
	...
	public void onGetDetailSearchResult(DetailSearchResult result, int error) {
		if (result != null) {
			if (result.poiInfo != null) {
				Toast.makeText(CloudSearchMap.this, result.poiInfo.title, Toast.LENGTH_SHORT).show();
			} else {
				Toast.makeText(CloudSearchMap.this, "status:" + result.status, Toast.LENGTH_SHORT).show();
			}
		}
	}
