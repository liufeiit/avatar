...
public class PoiSearchMap extends FragmentActivity implements OnGetPoiSearchResultListener,
	...
	public void onGetPoiResult(PoiResult result) {
		...
		if (result.error == SearchResult.ERRORNO.AMBIGUOUS_KEYWORD) {
			...
			strInfo += "找到结果";
			Toast.makeText(PoiSearchMap.this, strInfo, Toast.LENGTH_LONG).show();
		}
	}
	...
	public void onGetPoiDetailResult(PoiDetailResult result) {
		if (result.error != SearchResult.ERRORNO.NO_ERROR) {
			Toast.makeText(PoiSearchMap.this, "抱歉，未找到结果", Toast.LENGTH_SHORT).show();
		} else {
			Toast.makeText(PoiSearchMap.this, "成功，查看详情页面", Toast.LENGTH_SHORT).show();
		}
	}
