...
public class SoundRecording extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// UI组件
		recordButton = (Button) this.findViewById(R.id.recording);
		stopButton = (Button) this.findViewById(R.id.stopRecording);
		final TextView tx1 = (TextView) this.findViewById(R.id.recordingInfo);
		// 录音按钮点击事件
