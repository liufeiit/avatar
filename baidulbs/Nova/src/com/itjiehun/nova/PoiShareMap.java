...
public class PoiShareMap extends Activity implements OnGetPoiSearchResultListener, OnGetShareUrlResultListener,
	...
	public void shareAddr(View view) {
		...
		Toast.makeText(this, String.format("搜索位置： %f，%f", mPoint.latitude, mPoint.longitude), Toast.LENGTH_SHORT)
				.show();
	}
	...
	public void onGetPoiResult(PoiResult result) {
		...
		if (result == null || result.error != SearchResult.ERRORNO.NO_ERROR) {
			Toast.makeText(PoiShareMap.this, "抱歉，未找到结果", Toast.LENGTH_LONG).show();
			return;
		}
		mBaiduMap.clear();
	...
	public void onGetReverseGeoCodeResult(ReverseGeoCodeResult result) {
		...
		mAddrMarker = (Marker) mBaiduMap.addOverlay(new MarkerOptions()
				.icon(BitmapDescriptorFactory.fromResource(R.drawable.icon_marka)).title(result.getAddress())
